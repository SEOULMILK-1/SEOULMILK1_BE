...
public record PostDetailResponse(Long postId, String userName, Role role, String title, String content, Long views, List<String> imgUrls, LocalDateTime updatedAt, List<CommentReadResponse> comments, Boolean pin) {
    public static PostDetailResponse from(Long postId, String userName, Role role, String title, String content, Long views, List<String> imgUrls, LocalDateTime updatedAt, List<CommentReadResponse> comments, Boolean pin) {
